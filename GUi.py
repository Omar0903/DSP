...
class App:
    ...
    def create_page_one(self):
        ...
        label = Label(self.master, text="Generation Wave Signals and plot it", font=25, background='white', width=50, height=2, justify="center")
        label.pack(pady=20)
    ...
    def create_page_two(self):
        label = Label(self.master, text="Operations on signals", font=25, bg='white')
        label.pack(pady=20)
    ...
    def create_page_three(self):
        label = Label( text="Quantization of Signals", font=25, bg='white',width=50)
