...
Lb7  = Label(fr3,text=' Inputs ',fg='black',bg='white',font=25,width=15)
...
En1 = Entry(fr3,fg='black',bg='white',font= 15,justify="center",width=15)
En2 = Entry(fr3,fg='black',bg='white',font= 15,justify="center",width=15)
En3 = Entry(fr3,fg='black',bg='white',font= 15,justify="center",width=15)
En4 = Entry(fr3,fg='black',bg='white',font= 15,justify="center",width=15)
En5 = Entry(MainScreen,fg='black',bg='white',font= 15,justify="center",width=10)

bt1.place(x=50,y=470)
bt2.place(x=200,y=470)
bt3.place(x=350,y=470)
bt4.place(x=500,y=470)
bt5.place(x=650,y=470)
bt6.place(x=800,y=470)
bt7.place(x=950,y=470)
bt8.place(x=1100,y=470)
bt9.place(x=50,y=540)
...
cmbo1.place(x=445,y=310,height=23,width=50)
